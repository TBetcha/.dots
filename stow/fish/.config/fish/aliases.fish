...
abbr lest "cd ~/code/dmg/legacyprovideronboarding/state/dmg.legacy-provider-onboarding-app.state"
abbr meapi "cd ~/code/dmg/members/api/dmg.providerorg-member-edit-app.api"
abbr mest "cd ~/code/dmg/members/state/dmg.providerorg-member-edit-app.state"
abbr csapi "cd ~/code/dmg/companysettings/api/dmg.providerorg-profile-edit-app.api"
abbr csst "cd ~/code/dmg/companysettings/state/dmg.providerorg-profile-edit-app.state"
abbr opapi "cd ~/code/dmg/opportunities/api/dmg.opportunity-app.api"
abbr opst "cd ~/code/dmg/opportunities/state/dmg.opportunity-app.state"
...
abbr apst "cd ~/code/dmg/approvaldashboard/state/dmg.approval-dashboard-app.state"
...
abbr fast "cd ~/code/dmg/fastaccept/state/dmg.fast-accept-app.state"
abbr myst "cd ~/code/dmg/myjobs/state/dmg.my-jobs-app.state"
...
abbr pdst "cd ~/code/dmg/providerdashboard/state/dmg.provider-dashboard-app.state"
